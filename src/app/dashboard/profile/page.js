...
//     // Optionally handle the case where user data failed to load
//     if (!user) {
...
// //         <div className=' bg-gradient-to-r  from-blue-800 to-indigo-900 h-[200px] absolute w-[75%] z-2'>
...
// //         </div>
// //           </div>
// // <div className='w-full h-[300px] top-[-60px] relative z-1 '>
// //         <div className='flex items-center justify-center '>
// //           <Avatar src="/Muhammad.jpg" sx={{ width: 150, height: 150 }} className="relative "/>
// //         </div>
// // </div>
// //         </div>
...
// <div className="flex items-center h-[400px] flex-wrap mx-auto  lg:my-0">
...
//           <img src="./Muhammad.jpg"/>
//         </div>

//         <h1 className="text-3xl text-primaryBlue font-bold pt-8 lg:pt-0">{user.name}</h1>
//         <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-blue-600 opacity-25"></div>
//         <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start text-gray-800">
//             <svg className="h-4 fill-current text-primaryBlue pr-4" xmlns="http://www.w3.org/2000/svg"
//                 viewBox="0 0 20 20">
//                 <path
...
//             <button className="bg-primaryBlue hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
//          Get In Touch
//      </button>
//         </div>
...
// <div className="w-full lg:h-[350px] lg:w-2/5">

//     <img src="/Muhammad.jpg" alt={user.name} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block"/>
...
<Box>
<div className="flex items-center flex-wrap mx-auto my-3 mb-3 lg:mb-0 lg:my-0">
...
<div id="profile"
    ...
    <div className="p-4 md:p-12 text-center lg:text-left">
        ...
        <div className="block lg:hidden rounded-full shadow-xl mx-auto mt-16 h-48 w-48 bg-cover bg-center">
          <img className='max-h-[300px] ' src="/Muhammad.jpg"/>
        </div>

        <h1 className="text-3xl lg:bg-transparent bg-white text-primaryBlue font-bold pt-8 lg:pt-0">{user?.name}</h1>
        <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-blue-600 opacity-25"></div>
        <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start text-gray-800">
            <svg className="h-4 fill-current text-primaryBlue pr-4" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20">
...
<div className="w-full lg:max-h-[350px] lg:w-2/5">

    <img src="/Muhammad.jpg" className="rounded-none mb-10 lg:rounded-lg shadow-2xl hidden lg:block"/>
